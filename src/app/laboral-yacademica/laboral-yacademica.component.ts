...
@Component({
  selector: 'app-laboral-yacademica',
  templateUrl: './laboral-yacademica.component.html',
  styleUrls: ['./laboral-yacademica.component.scss']
})
export class LaboralYacademicaComponent implements OnInit {
